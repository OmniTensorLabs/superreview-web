...
Preview changes at desktop and mobile sizes. Verify navigation, agent selection,
and clipboard behavior. Do not introduce dependencies or a build step without a concrete need.
Stage files explicitly and do not bypass hooks.
